	...
	<table class="table table-responsive">
		<tr class="mb-1">
			...
			<td class="pb-1">
				...
				<input type="text" class="form-control editable" required name="mem_id" 
...
<div class="modal fade" id="zipModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
